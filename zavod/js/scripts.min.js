	...
	var touchSlider = {
		...
		init: function() {
			...
			if(this.opts.controls) {
				this._controls.append('<button type="button" class="ts-prev"><i class="i-left-arrow"></i></button><button type="button" class="ts-next"><i class="i-right-arrow"></i></button>');
				this._tg.after(this._controls);
